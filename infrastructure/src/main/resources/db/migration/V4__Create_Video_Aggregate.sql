...
CREATE TABLE videos_genres (
    ...
    CONSTRAINT fk_vgs_genres_id FOREIGN KEY (genre_id) REFERENCES genres (id)
);
...
CREATE TABLE videos_cast_members (
    ...
    CONSTRAINT fk_vcms_cast_members_id FOREIGN KEY (cast_member_id) REFERENCES cast_members (id)
);