...
public record VideoResponse(
    ...
    @JsonProperty("thumbnail") ImageMediaResponse thumb,
    @JsonProperty("thumbnail_half") ImageMediaResponse thumbHalf,
    ...
    @JsonProperty("cast_member_id") Set<String> castMembers
) {
