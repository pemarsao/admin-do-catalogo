...
public class CastMemberAPITest {
    ...
    public void givenAValidCommand_whenCallsCreateCastMember_shouldReturnCastMemberID() throws Exception {
        ...
        final var expectedId = CastMemberID.from("1234546");
    ...
    @Test
    public void givenAValidId_whenCallsGetCastMember_shouldReturnCastMember() throws Exception {
        // given
        final var expectedName = Fixture.name();
        final var expectedType = Fixture.CastMembers.type();
        ...
        when(getCastMemberByIdUseCase.execute(any())).thenReturn(GetCastMemberOutput.from(aMember));

        // when
        final var request = get("/cast_members/{cast_member_id}", expectedId).with(ApiTest.CAST_MEMBERS_JWT);
        final var response = mvc.perform(request);
    ...
    @Test
    public void givenAnInvalidId_whenCallsGetCastMember_shouldReturnNotFound() throws Exception {
        // given
        ...
        // when
        final var request = get("/cast_members/{cast_member_id}", expectedId.getValue()).with(ApiTest.CAST_MEMBERS_JWT);
        final var response = mvc.perform(request);
    ...
    @Test
    public void givenAValidCommand_whenCallsDeleteCastMember_thenShouldReturnNoContent() throws Exception {
        // given
        final var expectedId = CastMemberID.from("123");
        ...
        // when
        final var request = delete("/cast_members/{id}", expectedId.getValue()).with(ApiTest.CAST_MEMBERS_JWT);
        final var response = mvc.perform(request);
    ...
    @Test
    public void givenAValidParams_whenCallsListCastMembers_shouldReturnPaged() throws Exception {
        // given
    ...
    @Test
    public void givenADefaultParams_whenCallsListCastMembers_shouldReturnPaged() throws Exception {
        // given
        final var aMember = CastMember.newMember(Fixture.name(), Fixture.CastMembers.type());
